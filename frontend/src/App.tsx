...
const App: React.FC = () => {
  ...
  useEffect(() => {
    const API_URL = import.meta.env.VITE_API_URL || (import.meta.env.DEV ? 'http://localhost:5001/api/problems' : 'https://python-learning-platform-se5q.onrender.com/api/problems');
    fetch(API_URL)
      .then(res => {
